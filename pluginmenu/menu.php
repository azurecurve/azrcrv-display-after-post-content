 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_dapc')){
	function azrcrv_create_plugin_menu_dapc(){
		azrcrv_populate_plugin_menu_dapc();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_dapc')){
	function azrcrv_populate_plugin_menu_dapc(){
