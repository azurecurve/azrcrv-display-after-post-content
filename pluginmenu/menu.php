 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_dasp')){
	function azrcrv_create_plugin_menu_dasp(){
		azrcrv_create_plugin_menu_table_dasp();
		azrcrv_populate_plugin_menu_table_dasp();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_dasp')){
	function azrcrv_populate_plugin_menu_table_dasp(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_dasp')){
	function azrcrv_create_plugin_menu_table_dasp(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
