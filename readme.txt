...
== Installation ==
To install the Display After Post Content plugin:
* Download the plugin from <a href='https://github.com/azurecurve/azrcrv-display-after-post-content/'>GitHub</a>.
* Upload the entire zip file using the Plugins upload function in your ClassicPress admin panel.
* Activate the plugin.
* Set the content to display after the psot content via the admin settings page.
